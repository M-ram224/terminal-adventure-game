# Extra ideas we wanted to add, yet did not have enough time to aded...
...
def fight_action num
    # If Attacks : rolls attack code  if roll 13 -20 slays dragon if below 13 roll again with message "Dont give up !" (if code available to run again do it)
    if num == '1'
        attack = rand(20) 
        if attack < 10  
